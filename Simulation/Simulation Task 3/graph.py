...
mean_df = pd.read_csv('./data_output/mean_outputs.csv',names=["RT_mean", "RT_mean_lower_CI", "RT_mean_upper_CI", "nonRT_mean", "nonRT_mean_lower_CI", "RT_mean_upper_CI"])
percentile_df = pd.read_csv('./data_output/95thPercentile_outputs.csv',names=["RT_95th", "RT_95th_lower_CI", "RT_95th_upper_CI", "nonRT_95th", "nonRT_95th_lower_CI", "RT_95th_upper_CI"])
...
plt.bar(r2, nonRT_bar, width = barWidth, color = 'brown', edgecolor = 'black', yerr=nonRT_yerr, capsize=7, label='nonRT mean')
...
plt.bar(r2, nonRT_bar, width = barWidth, color = 'brown', edgecolor = 'black', yerr=nonRT_yerr, capsize=7, label='nonRT 95th percentile')
